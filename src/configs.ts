...
export const errorMessages = {
    ...
    textRequired: 'Text is required in request body'
}
...
export const dictionaryMapping = ((): Record<string, WordType> => {
    return Object.entries(dictionary).reduce((mapping, [wordType, words]) => {
        words.forEach((word) => mapping[word] = wordType as WordType);
        return mapping;
